...
```php  
$response = BootpayApi::subscribePaymentReserveLookup('62b41f88cf9f6d001ad212ad');
var_dump($response); 
```
...
```php  
$response = BootpayApi::cancelSubscribeReserve('62b41f68cf9f6d001ad212a5');
var_dump($response); 
```
...
```php  
$response = BootpayApi::lookupBillingKey('62b41f68cf9f6d001ad212a5');
var_dump($response); 
```
